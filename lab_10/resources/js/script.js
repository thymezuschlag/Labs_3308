...
//this is ajax call
    ...
    data.current.temperature = getFarenheitTemp(data.current.temperature);
    ...
    //five day loop with getkey(i)
    //var temp = "";
    //temp = temp+"<div style='width: 20%;'><div class ='card-body'><h5 class='card-title'>" + "Day" + "</h5></div></div>";
    //document.getElementById("5_day_forecast").innerHTML = temp;

    //console.log(data)
    //console.log(getKey(1))
    //document.getElementById("5_day_forecast").innerHTML = data.current.precip;
    //document.getElementById("5_day_forecast").innerHTML = temp;
    //document.getElementById("5_day_forecast").innerHTML = temp;
    //document.getElementById("5_day_forecast").innerHTML = temp;
    ...
    for(i=0; i<5; i++)
    {
      ...
      cards += `<div style='width: 20%;'>
        ...
        <h5 class="card-title">${dayOfWeek}  </h5>
          <p class="card-text">
            High: ${getFarenheitTemp(forecast.maxtemp)} <br>
            Low: ${getFarenheitTemp(forecast.mintemp)} <br>
